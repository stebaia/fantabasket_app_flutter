...
class AppRouter extends _i14.RootStackRouter {
  ...
  final Map<String, _i14.PageFactory> pagesMap = {
    ...
    LoginRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i14.WrappedRoute(child: const _i3.LoginPage()),
      );
    },
    RegistrationRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i14.WrappedRoute(child: const _i4.RegistrationPage()),
      );
    },
    ...
    LoadStagesRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i14.WrappedRoute(child: const _i6.LoadStagesPage()),
      );
    },
    ...
    CreateTeamRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i14.WrappedRoute(child: const _i10.CreateTeamPage()),
      );
    },
    RankRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i11.RankPage(),
      );
    },
    ...
    ContainerRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i13.ContainerPage(),
      );
    },
  };
...
/// generated route for
/// [_i5.CorePage]
class CoreRoute extends _i14.PageRouteInfo<void> {
  const CoreRoute({List<_i14.PageRouteInfo>? children})
      : super(
          CoreRoute.name,
          path: 'core',
          initialChildren: children,
...
/// generated route for
/// [_i6.LoadStagesPage]
class LoadStagesRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i7.SelectTeamPage]
class SelectTeamRoute extends _i14.PageRouteInfo<SelectTeamRouteArgs> {
  SelectTeamRoute({
    _i15.Key? key,
    required _i16.Stage stage,
  }) : super(
          SelectTeamRoute.name,
          path: 'select_team_page',
...
/// generated route for
/// [_i8.CompletionPage]
class CompletionRoute extends _i14.PageRouteInfo<CompletionRouteArgs> {
  CompletionRoute({
    _i15.Key? key,
    required List<_i17.Player> team,
    required List<_i17.Player> side,
    required _i16.Stage stage,
  }) : super(
          CompletionRoute.name,
          path: 'completion_page',
...
class CompletionRouteArgs {
  ...
  final List<_i17.Player> team;

  final List<_i17.Player> side;
...
/// generated route for
/// [_i9.RankDetailPage]
class RankDetailRoute extends _i14.PageRouteInfo<RankDetailRouteArgs> {
  RankDetailRoute({
...
class TopBarContainerRouter extends _i14.PageRouteInfo<void> {
  const TopBarContainerRouter({List<_i14.PageRouteInfo>? children})
      : super(
          TopBarContainerRouter.name,
          path: 'container',
          initialChildren: children,
...
/// generated route for
/// [_i10.CreateTeamPage]
class CreateTeamRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i11.RankPage]
class RankRoute extends _i14.PageRouteInfo<void> {
  const RankRoute()
      : super(
          RankRoute.name,
          path: 'rank_page',
...
/// generated route for
/// [_i13.ContainerPage]
class ContainerRoute extends _i14.PageRouteInfo<void> {

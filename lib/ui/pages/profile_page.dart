...
import 'package:fantabasket_app_flutter/utils/image_picker_body.dart';
                    ...
                    showModalBottomSheet(
                        ...
                        builder: ((modalContext) => CustomBaseBottomSheet(
                              ...
                              body: Column(
                                ...
                                children: [
                                  const Text(
                                    'Inserisci la tua mail per richiedere la cancellazione',
                                    style:
                                  ...
                                  FunctionButton(
                                    ...
                                    onPressed: () {
                                      if (controllerEmail.text.isNotEmpty) {
                                        ...
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(SnackBar(
                                          content: Text('Inserire una mail'),
